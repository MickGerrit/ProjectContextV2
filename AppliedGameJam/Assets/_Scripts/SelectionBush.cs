...
public class SelectionBush : MonoBehaviour {
    ...
    void Update() {
        ...
        if (selectionArrow.isSelecting && selectionArrow.isSelectingBush && selectionArrow.prevObject.GetComponentInChildren<Bush>().hasMushCaps == true)
        {
